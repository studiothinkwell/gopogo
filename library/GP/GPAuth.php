...
Class GP_GPAuth
{
     ...
     * @param String $name : user name
     */
    public static function sendEmailSignupConfirm($email,$passwd,$confirmLink,$name='',$case) {
        $obj = self::getIntance();
        $configs = $obj->getConfig();
    ...
    public static function sendAccountPasswordChange($email,$passwd,$name='') {
        ...
        $lang_msg = self::getIntance()->translate->_('    "Your gopogo account email has been changed"=>"Your gopogo account email has been changed",
');
    ...
    /**
     * Send Email change info to user
     * @param String $email : user old email
     * @param String $primaryEmail : updated email
     */
    public static function sendAccountEmailUpdate($email,$primaryEmail) {
        $obj = self::getIntance();
        $configs = $obj->getConfig();
        ...
        $view->email = $email;
        $view->link = $baseurl;
        $view->primaryEmail = $primaryEmail;

        $text = $view->render('mails/email_update_info_user.phtml');


        $lang_msg = self::getIntance()->translate->_('Your gopogo account email has been changed');
